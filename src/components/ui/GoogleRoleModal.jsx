...
import { HiOutlineX, HiOutlineSparkles, HiOutlineAcademicCap, HiOutlineUserGroup } from 'react-icons/hi';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-sm w-full overflow-hidden">
                ...
                <div className="bg-gradient-to-br from-blue-600 to-emerald-600 p-6 text-center">
                    ...
                    <p className="text-blue-200 text-sm mt-1">{userInfo.name}</p>
                    <p className="text-blue-300 text-xs">{userInfo.email}</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {[
                                { value: 'STUDENT', label: 'Şagird', Icon: HiOutlineAcademicCap },
                                { value: 'TEACHER', label: 'Müəllim', Icon: HiOutlineUserGroup },
                    ...
                    <div>
                        <label className="flex items-start gap-3 cursor-pointer">
                            ...
                            <span className="text-sm text-gray-600 leading-relaxed">
                                <a href="/istifade-sertleri" target="_blank" className="text-blue-600 hover:underline font-medium">İstifadə şərtlərini</a>
                                {' '}və{' '}
                                <a href="/gizlilik-siyaseti" target="_blank" className="text-blue-600 hover:underline font-medium">Gizlilik Siyasətini</a>
                                {' '}oxuyub qəbul edirəm
                            </span>
                        </label>
                    </div>
